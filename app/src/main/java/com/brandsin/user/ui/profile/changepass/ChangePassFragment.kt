...
class ChangePassFragment : BaseHomeFragment(), Observer<Any?> {
    ...
    private lateinit var binding: ProfileFragmentChangePassBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.profile_fragment_change_pass,
            container,
            false
        )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this)[ChangePassViewModel::class.java]
