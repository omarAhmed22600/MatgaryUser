...
class StoreProductsAdapter_V2 : RecyclerView.Adapter<BaseViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BaseViewHolder {
        ...
        return when (viewType) {
            ...
            VIEW_TYPE_LOADING ->{
                val binding: DialogProgressBinding = DataBindingUtil.inflate(layoutInflater, R.layout.dialog_progress, parent, false)
...
////                    var visiblePosition=llm.findFirstVisibleItemPosition()
////                    Log.d("visiblePosition", visiblePosition.toString())
////                    var categoryId=productsList[visiblePosition].category_id
////                    if (lastScrollPostion!=categoryId!!){
////                        productLiveData2.value=categoryId.toString()
////                    }
////                    lastScrollPostion=categoryId
////                }
////            })
////        }
////    }
//    }
    ...
    inner class ViewHolder internal constructor(val binding: RawStoreProductBinding) : BaseViewHolder(binding.root) {
        override fun clear() {}
        ...
        override fun onBind(position: Int) {
            ...
            if(itemViewModel.item.description==null||itemViewModel.item.description=="null"){
                ...
                binding.tvDescription.text=html2text(itemViewModel.item.description.toString())
            }
...
//        }
    ...
    class ProgressHolder internal constructor(val binding: DialogProgressBinding) : BaseViewHolder(binding.root) {
